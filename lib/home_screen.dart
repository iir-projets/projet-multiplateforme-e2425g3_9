          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Colors.black, Color(0xFF808000)], // Dégradé noir et vert olive
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Bienvenue à votre infinite books shelf',
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      _buildFeatureCard(
                        icon: Icons.people,
                        title: 'Historique de vos emprunts',
                        onTap: () {
                          Navigator.push(
                            context,
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, size: 50, color: const Color(0xFFFAEBD7)), // Icône beige pâle
              const SizedBox(height: 10),
              Text(
                title,
