...
public class EmployeeController {
	...
	public ResponseEntity<Boolean> loginEmployee(@RequestBody Map<String, String> credentials) {
		String fname = credentials.get("fname");
		String lname = credentials.get("lname");

		// Vérifie si un employé existe avec les noms donnés
		boolean exists = employeeRepository.existsByFnameAndLname(fname, lname);
